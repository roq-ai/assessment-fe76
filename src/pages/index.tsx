  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Unlock your potential with Assessment - the software designed to empower employees through comprehensive and insightful evaluations."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1484480974693-6ca0a78fb36b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxhc3Nlc3NtZW50fGVufDB8fHx8MTY5MDk2MDU5MHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Unlock your potential with Assessment - the software designed to empower employees through comprehensive and insightful evaluations.`}
            </Text>
            <Box
            ...
            >
              <Stack direction="column" spacing={6}>
                <Card userTypeName="Organization Owner" type="organization-owner" />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
