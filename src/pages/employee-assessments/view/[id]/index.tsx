...
import { getEmployeeAssessmentById } from 'apiSdk/employee-assessments';
import { EmployeeAssessmentInterface } from 'interfaces/employee-assessment';

function EmployeeAssessmentViewPage() {
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Employee Assessment Details',
              isCurrent: true,
            },
          ]}
        />
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('employee_assessment', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/employee-assessments/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                {hasAccess('assessment', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    label="Assessment"
                    text={
                      <Link as={NextLink} href={`/assessments/view/${data?.assessment?.id}`}>
